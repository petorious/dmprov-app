...
// import BreakpointConfig from '../../config_breakpoint/configBreakpoint';
...
// export default class EzReactGridLayout extends React.Component {
...
//    // const layouts = this.props.layouts.map(w => w.key);
...
//   getDashboardLayout(layouts){
//     return firebase.database().ref(`/dashboards/`)
//   }
